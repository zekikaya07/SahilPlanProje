...
namespace SahilPlanProje.WebApi.Controllers
{
    ...
    [ApiController]
    public class TahakkukInstitutionsController : ControllerBase
    {
        private readonly ApiContext _context;
        private readonly IMapper _mapper;

        public TahakkukInstitutionsController(ApiContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> UpdateCity(int id, [FromBody] UpdateTahakkukInstitutionDto city)
        {
            ...
            var existingCity = await _context.TahakkukInstitutions.FindAsync(id);
